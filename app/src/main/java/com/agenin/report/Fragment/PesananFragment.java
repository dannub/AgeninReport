...
public class PesananFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView = inflater.inflate(R.layout.fragment_pesanan, container, false);

        recyclerView = itemView.findViewById(R.id.payment_recycleview);
...
//                                System.out.println(date.getTime());
                                ...
                                //                             DBqueries.loadPayment(MainActivity.this, loadingDialog, dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
                            }
                        }, year, month, day);
...
//        }
        ...
        paymentAdapter = new PaymentAdapter(DBQueries.uploadBuktiModelList,getContext(),loadingDialog);
    ...
    private void reloadPage() {
        ...
        if (networkInfo != null && networkInfo.isConnected() == true) {
            ...
            DBQueries.loadPayment(getContext(),loadingDialog, tgl_from.getText().toString(),tgl_to.getText().toString());
